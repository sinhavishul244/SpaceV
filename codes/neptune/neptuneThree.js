...
const Neptune_geometry = new THREE.SphereGeometry(radiusPlanet, 50, 50);
const Neptune_material = new THREE.MeshPhongMaterial(
    {
        // color: 0xFF0000,
        map: new THREE.TextureLoader().load('./planet-resources/2k_neptune.jpg'),
    }
);
const Neptune = new THREE.Mesh(Neptune_geometry, Neptune_material);
scene.add(Neptune);
Neptune.rotateY(((5 * Math.PI) / 6) + Math.PI / 2);
