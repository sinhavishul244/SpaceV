...
// main uranus sphere
const radiusUranus = 2.75;
const Uranus_geometry = new THREE.SphereGeometry(radiusUranus, 50, 50);
const Uranus_material = new THREE.MeshPhongMaterial(
    {
        // color: 0xFF0000,
        map: new THREE.TextureLoader().load('./planet-resources/Uranus_map-3.jpg'),
    }
);
